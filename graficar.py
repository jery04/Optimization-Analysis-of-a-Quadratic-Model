...
from max_descenso import maximo_descenso_optimo  # Importar sin modificar max_descenso.py
from newton import newton_quadratic  # Método de Newton para función cuadrática
